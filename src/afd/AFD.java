        ...
        for (int i = 0; i < (listaTokens.size() - 1); i++) {
            switch (listaTokens.get(i).getType()){
                ...
                case 92:
                    ...
                    sAux = "q0" + "->" + "str1" + " [label=\"" + "aspas duplas" + "\"];";
                    sAux += "str1" + "->" + "str1" + " [label=\"" + "Qualquer coisa menos barra invertida" + "\"];";
                    sAux += "str2 [shape=doublecircle];\n";
                    sAux += "str1" + "->" + "str2" + " [label=\"" + "aspas duplas" + "\"];";
                ...
                case 91:
                    sAux = "q0" + "->" + "ch1" + " [label=\"" + "'" + "\"];";
                    sAux += "ch1" + "->" + "ch2" + " [label=\"" + "Qualquer coisa menos aspas duplas e barra invertida" + "\"];";
                    sAux += "ch2" + "->" + "ch3" + " [label=\"" + "'" + "\"];";
